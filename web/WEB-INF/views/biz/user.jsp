...
<div class="container">
    ...
    <form class="form-horizontal" action="${path}/editUserPrompt.do" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="name" name="username" value="${user.name}" readonly="readonly">
            </div>
        </div>
        <div class="form-group">
            <label for="realName" class="col-sm-2 control-label">姓名 ：</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="realName" value="${user.realName}" readonly="readonly">
            </div>
        </div>
        <div class="form-group">
            <label for="birthday" class="col-sm-2 control-label">生日 ：</label>
            <div class="col-sm-8">
                <input name=""  class="form-control" rows="3" id="birthday" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birthday}"/>" readonly>
            </div>
        </div>
        <div class="form-group">
